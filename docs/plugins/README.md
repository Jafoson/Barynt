...
| [Security](security.md) | What can go wrong when a plugin runs and what stops it: why tier B code has the power of the app, the integrity check on every load, and the open decision on how strict to be. |
