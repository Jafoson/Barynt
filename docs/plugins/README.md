...
| [The plugins of a workspace](workspace.md) | Workspace settings, Plugins: which of the platform's plugins a workspace switches on, what keeps one from running (and disables its switch), what is not passed on to a workspace admin. |
