...
| [Lifecycle](lifecycle.md) | The platform's part of a plugin's life: install, update, uninstall, switch off. Where the files come from today, the rule for a plugin from no store, what is checked before a change, what a change does to the other plugins. |
